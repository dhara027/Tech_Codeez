      ...
      <section className="bg-gradient-to-r from-noor-brown to-noor-darkBrown py-20">
        <div className="container-width section-padding text-center text-white">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            We're a team of certified technology architects and engineers dedicated to
            accelerating business growth through innovative digital solutions and system 
            optimizations.
          </p>
        </div>
      </section>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="text-noor-gray mb-4">
          At <strong>Tech Codeez </strong>, our mission is to develop reliable, innovative IT solutions that address real-world business challenges and deliver measurable value.
        </p>
        <p className="text-noor-gray mb-4">
          We are committed to providing exceptional customer service and personalized support, empowering our clients to achieve operational excellence and seamless digital transformation.
        </p>
        <p className="text-noor-gray mb-4">
          Leveraging emerging technologies, we build scalable and future-ready systems while upholding integrity, transparency, and quality in every project.
        </p>
        <p className="text-noor-gray">
          Our goal is to create long-term value for our clients, partners, and communities by integrating cutting-edge innovation with uncompromising service standards.
        </p>
      </div>
        ...
        <div className="container-width section-padding text-center text-white">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
           Let's discuss how we can help your business achieve
            its technology goals through innovative and reliable IT solutions.
          </p>
          <Button
            asChild
